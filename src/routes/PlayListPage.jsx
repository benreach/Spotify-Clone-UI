...
function PlayListPage() {
  return (
    <div className="">
      <div className="flex gap-2 items-center h-[72px] px-4 sticky top-0 z-20 bg-lightBlack">
        ...
        <h1 className="font-bold text-2xl text-white">Discover Weekly</h1>
      </div>
      <div className="flex items-end gap-4 px-4 py-4 z-0 bg-gradient-to-b from-pink-300 to-lightBlack">
        ...
        <div className="flex flex-col gap-4">
          <span>Playlist</span>
          <h1 className="font-bold text-6xl">Discover Weekly</h1>
          <span>
