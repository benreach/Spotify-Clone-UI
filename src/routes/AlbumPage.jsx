...
import SingleCollection from "../components/leftSide/SingleCollection";
  ...
  return (
    <div className="">
      <div className="flex gap-2 items-center h-[60px] px-4 sticky top-0 z-20 bg-gradient-to-b from-lightBlack to-blackColor">
        ...
        <h1 className="font-bold text-lg md:text-2xl text-white">For You</h1>
      </div>
      <div className="flex items-end gap-4 px-4 py-4 z-0 bg-gradient-to-b from-blue-300 to-lightBlack">
        ...
        <div className="flex flex-col gap-4">
          <span>Single</span>
          <h1 className="font-bold text-2xl md:text-6xl">For You</h1>
          <span className="hidden">
            Your weekly mixtape of fresh music. Enjoy new music and deep cuts
            picked for you. Updates every Monday.
          </span>
          <div className="flex items-center gap-1">
            <img src="/spotify.svg" alt="" width={24} className="hidden md:block"/>
            <span className="hidden md:block">Spotify</span>
            <span>1 song</span>
            <span className="hidden sm:block">,3 mins</span>
          </div>
        </div>
      </div>
      <div className="px-2">
        ...
        <Album title="For You" category={"artist"} />
      </div>
    </div>
  );
}
