    ...
    <div className="flex justify-between items-center h-[48px] py-2 px-2 mt-1 mb-1 ml-2" >
      ...
      <div className="flex-1 flex justify-between items-center relative gap-2">
        ...
        <div className=" relative">
          ...
          />
          <div className="border-l-[1px] absolute right-10 w-0 h-6 top-2 bg-lightBlack"></div>
          <div className="py-2 px-2 absolute right-0 top-0 z-1 cursor-pointer">
            <svg
              data-encore-id="icon"
              role="img"
              aria-hidden="true"
      ...
      <div className="flex-1 flex justify-end items-center gap-6">
        ...
        <div>
          <svg
            role="img"
            aria-hidden="true"
            className="e-9640-icon cursor-pointer"
            viewBox="0 0 16 16"
            fill="white"
            height={15}
          >
        ...
        <button className="p-2 bg-lightBlack rounded-full">
          <img src="/profile.svg" alt="" width={30} className="rounded-full cursor-pointer" />
        </button>
      </div>
    </div>
  );
